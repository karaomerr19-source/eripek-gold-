...
function Shell({children}:{children:React.ReactNode}){return <main className="page"><section className="phone"><div className="top"><div className="brand"><span className="gold">MP</span> &nbsp; MASTER PORCELENTA</div><div className="sub">Eripek Gold</div></div>{children}</section></main>}
